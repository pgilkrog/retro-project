...
router.get('/', auth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, index_1.Program.find()];
            case 1:
...
router.delete('/:id', auth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var deletedItem, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, index_1.Program.findByIdAndDelete({ _id: req.params.id })];
            case 1:
                deletedItem = _a.sent();
...
router.post('/', auth_1.default, jsonParser, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, image, color, displayName, sortOrder, type, newProgram, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.query, name = _a.name, image = _a.image, color = _a.color, displayName = _a.displayName, sortOrder = _a.sortOrder, type = _a.type;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                newProgram = new index_1.Program({
                    name: name,
                ...
                return [4 /*yield*/, newProgram.save()];
            case 2:
                _b.sent();
                res.json(newProgram);
                return [3 /*break*/, 4];
...
router.put('/:id', auth_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, programToUpdate, updateProgram, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("UPDATE USER");
                id = req.params.id;
                programToUpdate = req.query;
                console.log("body", programToUpdate);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, index_1.Program.findByIdAndUpdate(id, programToUpdate, { new: true })];
            case 2:
